...
myhost = get_cname_record(hostname,domainname,apiKey,hmac,requestDate)
...
if myhost
  ...
  delete_cname_record(myhost["id"],domainname,apiKey,hmac,requestDate)
end
...
dnsrecord = { "name" => hostname,
              ...
              "gtdLocation" => "DEFAULT",
              "ttl" => 300 }
post_cname_record(dnsrecord,domainname,apiKey,hmac,requestDate)
